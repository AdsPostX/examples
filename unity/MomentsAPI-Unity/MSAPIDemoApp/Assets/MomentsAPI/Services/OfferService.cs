...
namespace MomentsAPI.Services
{
    ...
    public class OfferService
    {
            ...
            Action<string> onError = null)
        {
            ...
            Debug.Log($"isDevelopment parameter value: {isDevelopment}");
            if (isDevelopment)
            {
                requestPayload["dev"] = "1";
                Debug.Log("Added dev=1 to payload");
            }
            ...
            string jsonPayload = ConvertDictionaryToJson(requestPayload);
            Debug.Log("requestPayload: " + jsonPayload);
